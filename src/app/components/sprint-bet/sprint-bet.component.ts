  ...
  template: `
    <div class="form-container">
      <mat-card class="form-card">
        <mat-card-header>
          <mat-card-title>Place Sprint Bet</mat-card-title>
        </mat-card-header>
        <mat-card-content>
          <form [formGroup]="sprintBetForm" (ngSubmit)="onSubmit()">
            ...
            <button mat-raised-button color="primary" class="full-width-button" type="submit" [disabled]="sprintBetForm.invalid || loading">
              Submit Sprint Bet
            </button>
          </form>
        </mat-card-content>
...
export class SprintBetComponent implements OnInit {
  ...
  onSubmit(): void {
    if (this.sprintBetForm.valid) {
      this.loading = true;
      const payload = { ...this.sprintBetForm.value };
